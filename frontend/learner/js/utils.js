...
/** All supported market/instrument categories used for interests and feed filters */
export const MARKETS = [
  'Nifty 50', 'Bank Nifty', 'Sensex', 'Midcap', 'Smallcap',
  'Crypto', 'Forex', 'Commodities', 'US Stocks', 'Options', 'Futures',
];
